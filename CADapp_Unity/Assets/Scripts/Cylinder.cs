...
//    public Slider radiusSlider;
 //   public Slider segmentsSlider;
    ...
    void Start()
    {
        ...
        extrude = GameObject.Find("Solid_feature").GetComponent<extrude_solid>();
        //pos = GameObject.Find("Solid_feature").GetComponent<Transform>();
    ...
    void Update()
    {
        ...
        segments = extrude.segments;
        radius = extrude.radius;
